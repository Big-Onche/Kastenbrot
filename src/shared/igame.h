...
namespace game
{
    ...
    extern void cleanupsupportworker();
    ...
    extern void falltrigger(physent *d, bool local, float distance, float velocity);
    ...
    extern void requestworldchunk(int chunkx, int chunky, ullong cachehash = 0);

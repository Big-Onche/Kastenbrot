...
FVAR(thirdpersondistance, 0, 50, 50);
...
void gl_drawview()
{
    ...
    // while alpha geometry in front remains protected by its depth. Underwater, rendertransparent() inserts them before the final liquid surface.
    if(fogmat == MAT_AIR)
    {

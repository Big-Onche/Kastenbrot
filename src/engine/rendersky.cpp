...
{
    if(!deepStarsTexture) deepStarsTexture = textureload("media/sky/deep_stars.png", 3, true, false);
...
static bool loadMilkyWay()
{
    ...
    if(!milkyWayTexture) milkyWayTexture = textureload("media/sky/milky_way.png", 2, true, false);
    if(!milkyWayNoiseTexture) milkyWayNoiseTexture = textureload("media/noise/grass_wind.jpg", 0, true, false);
...
{
    if(!atmosphereMoonTexture) atmosphereMoonTexture = textureload("media/sky/moon.png", 3, true, false);

...
extern thread_local const cube *neighbourstack[32];
extern thread_local int neighbourdepth;
...
extern void processworldmeshuploads(bool drain = false);
extern void setasyncworldmeshing(bool enabled);
extern void flushworldmeshjobs();
extern void shutdownworldmeshworkers();
